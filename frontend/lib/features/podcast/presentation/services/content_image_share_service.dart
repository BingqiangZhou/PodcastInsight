...
const Color _kBarrierColor = Color(0x30000000);
...
class ContentImageShareService {
    ...
    try {
      ...
      final bytes = await _screenshotController.captureFromLongWidget(
        _buildShareCard(
          ...
          watermark: payload.watermark ?? 'Generated by Personal AI Assistant',
        ),
        context: context,
        pixelRatio: pixelRatio,
  ...
  static OverlayEntry? _showPreparingOverlay(
    ...
    final entry = OverlayEntry(
      builder: (_) {
        return Stack(
          children: [
            const ModalBarrier(dismissible: false, color: _kBarrierColor),
            Center(
              child: Material(
  ...
  static Widget _buildShareCard(
    ...
    String watermark = 'Generated by Personal AI Assistant',
  }) {
    final theme = Theme.of(context);
