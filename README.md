...
PodcastInsight 是一个全栈播客洞察管理平台，集成播客排行榜监控、音频转写、AI 摘要生成等功能，帮助你从播客内容中高效提取和管理知识。
...
# 数据库 (本地开发)
DATABASE_URL=postgresql+asyncpg://postgres:postgres@localhost:5432/podcastinsight
